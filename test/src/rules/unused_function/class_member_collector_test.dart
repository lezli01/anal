...
''',
    ...
    test(
      'does not additionally flag members of an unused private class',
      () async {
        final diagnostics = await runRule({
          'fixture.dart': '''
class _UnusedClass {
...
''',
        ...
        for (final diagnostic in diagnostics) {
          expect(diagnostic.message, isNot(contains('method')));
          expect(diagnostic.message, isNot(contains('getter')));
          expect(diagnostic.message, isNot(contains('setter')));
        }
      },
    );
